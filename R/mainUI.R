...
mainUI <- function() {
 bslib::page_sidebar(
  ...
  # Top navigation bar
  div(
   style = "background: linear-gradient(135deg, #2c3e50, #6c757d); padding: 15px; margin-bottom: 20px; border-radius: 8px; text-align: center;",
  ...
  sidebar = bslib::sidebar(
   ...
   div(
    style = "padding: 15px; margin-bottom: 20px; background: linear-gradient(135deg, #f8f9fa, #e9ecef); border-radius: 8px; border: 2px solid #6c757d;",
   ...
   hr(style = "border-top: 2px solid #6c757d; margin: 20px 0;"),
